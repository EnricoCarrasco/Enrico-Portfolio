						...
						<div className="box-linear-animation position-relative z-1 p-lg-5 p-1 p-md-4">
							<div className="position-relative z-1">
								<div className="text-center">
									...
									<h3>
										Van idee naar werkend AI-product {''}
										<span className="text-300">
											 - website, app, agent of volledige workflow
										</span>
									</h3>
								</div>
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">AI-producten &amp; SaaS bouwen</h4>
												<p className="fs-7 text-300 fw-regular">End-to-end eigen producten: <span className="text-secondary-2">Next.js/React/TypeScript</span>, <span className="text-secondary-2">Supabase</span> en <span className="text-secondary-2">Stripe</span>. Van MVP tot productie met tests, monitoring en deploys. Vijf eigen SaaS-producten live, waaronder HuurVos.nl.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">LLM-integraties</h4>
												<p className="fs-7 text-300 fw-regular">De <span className="text-secondary-2">Anthropic (Claude)</span> en <span className="text-secondary-2">OpenAI</span> API&apos;s in je product: AI-brieven, chat, classificatie en contentgeneratie. Prompt- en contextengineering voor betrouwbare output in productie.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Agents &amp; workflow-automatisering</h4>
												<p className="fs-7 text-300 fw-regular">Agentic workflows met <span className="text-secondary-2">Claude Code</span>, <span className="text-secondary-2">Codex</span> en <span className="text-secondary-2">MCP</span>. Complete pijplijnen zonder handwerk: scraping, datamatching, advertentiebeheer via API, publicatie en monitoring.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">iOS-apps</h4>
												<p className="fs-7 text-300 fw-regular"><span className="text-secondary-2">SwiftUI</span>-apps met push-notificaties (APNs) en App Store-release. Twee apps live in de App Store: <span className="text-secondary-2">Swaytype</span> (AI-toetsenbord) en de <span className="text-secondary-2">HuurVos-app</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Websites &amp; webshops</h4>
												<p className="fs-7 text-300 fw-regular">Conversiegerichte websites en webshops in <span className="text-secondary-2">Next.js</span>, <span className="text-secondary-2">WordPress</span> en <span className="text-secondary-2">Shopify</span>: betalingen, SEO en performance, versneld door AI.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">AI-media &amp; content</h4>
												<p className="fs-7 text-300 fw-regular">Contentpijplijnen die zichzelf draaien: video en beeld met <span className="text-secondary-2">fal.ai</span>, <span className="text-secondary-2">ElevenLabs</span>, <span className="text-secondary-2">HeyGen</span> en <span className="text-secondary-2">Remotion</span>, automatisch gepubliceerd via API&apos;s. Plus AI-features in je bestaande site.</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											Gepassioneerd over <span className="text-dark">bouwen met AI en problemen oplossen</span>. Van website tot volledig geautomatiseerde workflow, alles is haalbaar. <br />
