									...
									<div className="row g-4">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Database Beheer</h6>
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">API Ontwikkeling</h6>
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Prestatie Optimalisatie</h6>
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">E-commerce Oplossingen</h6>
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">AI Integratie</h6>
