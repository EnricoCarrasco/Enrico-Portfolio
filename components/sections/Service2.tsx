									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Het bouwen van professionele websites en applicaties. Van <span className="text-secondary-2">WordPress</span> en <span className="text-secondary-2">Shopify</span> sites tot moderne <span className="text-secondary-2">Next.js/React</span> applicaties (met AI-tools). Elk project op maat met de nieuwste technologieën.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">API &amp; Database Integraties</h4>
												<p className="fs-7 text-300 fw-regular">Ervaring met <span className="text-secondary-2">API koppelingen</span>, <span className="text-secondary-2">databases</span> en <span className="text-secondary-2">externe services</span>. Elke functionaliteit is realiseerbaar - van simpel tot complex. Bij React/Next.js projecten gebruik ik AI-tools voor snellere ontwikkeling.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Prestatie Optimalisatie</h4>
												<p className="fs-7 text-300 fw-regular">Verbeteren van de snelheid en prestaties van webapplicaties voor een betere gebruikerservaring. Werken met <span className="text-secondary-2">Nodejs</span>, <span className="text-secondary-2">Express</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">AI Integratie</h4>
												<p className="fs-7 text-300 fw-regular">Versterk uw applicaties met AI voor verbeterde efficiëntie, automatisering en een betere gebruikerservaring</p>
											</div>
										</div>
									</div>
