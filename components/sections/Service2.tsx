									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Website &amp; App Bouwen</h4>
												<p className="fs-7 text-300 fw-regular">Het bouwen van professionele websites en applicaties. <span className="text-secondary-2">WordPress</span> en <span className="text-secondary-2">Shopify</span> volledig zelfstandig, moderne <span className="text-secondary-2">Next.js/React</span> applicaties met AI-hulp (Claude Code, Cursor). Elk project op maat met de beste tools.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Data &amp; Database Oplossingen</h4>
												<p className="fs-7 text-300 fw-regular">Opzetten van databases zoals <span className="text-secondary-2">Supabase</span> en <span className="text-secondary-2">MySQL</span> voor moderne webapplicaties. Technische implementatie met AI-hulp voor betrouwbare data-oplossingen.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">API Koppelingen &amp; Integraties</h4>
												<p className="fs-7 text-300 fw-regular">Koppelen van <span className="text-secondary-2">externe services</span>, <span className="text-secondary-2">betalingen</span>, <span className="text-secondary-2">AI APIs</span> en meer. Elke functionaliteit is mogelijk - van simpel tot complex. Technische koppelingen realiseer ik met AI-tools (Claude Code) voor betrouwbare resultaten.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Snelheid &amp; Performance</h4>
												<p className="fs-7 text-300 fw-regular">Zorgen dat je website snel laadt en optimaal presteert voor de beste gebruikerservaring. Optimalisatie van afbeeldingen, code en server voor razendsnelle websites.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">Webshop Bouwen</h4>
												<p className="fs-7 text-300 fw-regular">Professionele webshops met <span className="text-secondary-2">Shopify</span>, <span className="text-secondary-2">WooCommerce</span> of custom oplossingen. Inclusief betalingen, voorraad en alle functionaliteit die je nodig hebt.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h4 className="my-3 fw-medium">AI Features Toevoegen</h4>
												<p className="fs-7 text-300 fw-regular">Voeg AI toe aan je website voor chatbots, automatisering, content generatie en slimme features. Integratie met <span className="text-secondary-2">OpenAI</span>, <span className="text-secondary-2">Claude</span> en andere AI services.</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											Gepassioneerd over <span className="text-dark">websites bouwen en problemen oplossen</span>. Elke website of functionaliteit is haalbaar. <br />
