...
export default function Header({ scroll, isMobileMenu, handleMobileMenu,isOffCanvas, handleOffCanvas }:any) {
    return (
        <>
            <header>
									...
									<div className="collapse navbar-collapse" id="navbarSupportedContent">
										<ul className="navbar-nav me-auto mb-2 mb-lg-0">
											<li className="nav-item">
												<Link className="nav-link active" href="#about">Over mij</Link>
											</li>
											<li className="nav-item">
												<Link className="nav-link" href="#resume">CV</Link>
											</li>
											<li className="nav-item">
												<Link className="nav-link" href="#services">Diensten</Link>
											</li>
											<li className="nav-item">
